...
{
  uint8_t value_optbyte, value_optbyte_complement = 0U;
  uint16_t res_value = 0U;
...
/**
  ...
  * @retval None.
  */
__ramfunc void FLASH_EraseBlock(uint16_t BlockNum, FLASH_MemType_TypeDef FLASH_MemType)
{
...
__ramfunc void FLASH_ProgramBlock(uint16_t BlockNum, FLASH_MemType_TypeDef FLASH_MemType, 
