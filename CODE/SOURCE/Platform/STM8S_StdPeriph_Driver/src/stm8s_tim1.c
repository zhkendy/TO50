...
uint16_t TIM1_GetCapture1(void)
{
  ...
  uint16_t tmpccr1 = 0U;
  uint8_t tmpccr1l=0, tmpccr1h= 0U;
...
uint16_t TIM1_GetCapture2(void)
{
  ...
  uint16_t tmpccr2 = 0U;
  uint8_t tmpccr2l=0, tmpccr2h= 0U;
...
uint16_t TIM1_GetCapture3(void)
{
  ...
  uint16_t tmpccr3 = 0U;
  uint8_t tmpccr3l=0, tmpccr3h= 0U;
...
uint16_t TIM1_GetCapture4(void)
{
  ...
  uint16_t tmpccr4 = 0U;
  uint8_t tmpccr4l=0, tmpccr4h= 0U;
...
FlagStatus TIM1_GetFlagStatus(TIM1_FLAG_TypeDef TIM1_FLAG)
{
  ...
  uint8_t tim1_flag_l = 0, tim1_flag_h = 0U;
...
ITStatus TIM1_GetITStatus(TIM1_IT_TypeDef TIM1_IT)
{
  ...
  uint8_t TIM1_itStatus = 0, TIM1_itEnable = 0U;
