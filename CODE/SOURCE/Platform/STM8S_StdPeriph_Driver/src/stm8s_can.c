...
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
__IO uint32_t _Id = 0U;
__IO uint8_t _IDE = 0U;
__IO uint8_t _RTR = 0U;
__IO uint8_t _DLC = 0U;
__IO uint8_t _Data[8] = {0};
__IO uint8_t _FMI = 0U;
...
{
  CAN_Page_TypeDef can_page = CAN_GetSelectedPage();
  uint32_t temp1 = 0, temp2 = 0, temp3 = 0U;
