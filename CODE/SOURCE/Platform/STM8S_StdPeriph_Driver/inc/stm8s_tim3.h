...
typedef enum
{
  TIM3_FLAG_UPDATE                   = ((uint16_t)0x0001u),
  TIM3_FLAG_CC1                      = ((uint16_t)0x0002u),
  TIM3_FLAG_CC2                      = ((uint16_t)0x0004u),
  TIM3_FLAG_CC1OF                    = ((uint16_t)0x0200u),
  TIM3_FLAG_CC2OF                    = ((uint16_t)0x0400u)
} TIM3_FLAG_TypeDef;
