...
#include "SetExtPeriphPowerMode.h"




TeIndustrialTestCmdError SetExtPeriphPowerMode_Execute(TsIndustrialTestCommandListenerInfo* _poListenerArg, ToTestFrameId _oTransmitFrameArg, ToTestFrameId _oReceiveFrameArg, TU8 _u8DataSizeArg, TU8* _pu8DataArg)
{  
  ...
  TU8                                   loc_u8ReceiveData[ET_SET_EXTPERIPH_POWERMODE_LENGTH];
  ...
  loc_eReturnValue = IndustrialTestCommandListener_Notify(_poListenerArg, ET_SET_EXTPERIPH_POWERMODE, &(loc_u8ReceiveData[COMMAND_DATA_POSITION]));
...
TeIndustrialTestCmdError SetExtPeriphPowerMode_ValidateAndFillAck(TsIndustrialTestCommandListenerInfo* _poListenerArg, ToTestFrameId _oTransmitFrameArg, ToTestFrameId _oReceiveFrameArg)
{  
  ...
  if(ET_SET_EXTPERIPH_POWERMODE == loc_u8FrameCmdId)
  {
