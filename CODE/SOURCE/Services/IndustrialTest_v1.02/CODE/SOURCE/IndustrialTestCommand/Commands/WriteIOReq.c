...
#include "WriteIOReq.h"




TeIndustrialTestCmdError WriteIoReq_Execute(TsIndustrialTestCommandListenerInfo* _poListenerArg, ToTestFrameId _oTransmitFrameArg, ToTestFrameId _oReceiveFrameArg, TU8 _u8DataSizeArg, TU8* _pu8DataArg)
{  
  ...
  TU8                                   loc_u8ReceiveData[ET_WRITE_IO_REQ_LENGTH];
  ...
  loc_eReturnValue = IndustrialTestCommandListener_Notify(_poListenerArg, ET_WRITE_IO_REQ, &(loc_u8ReceiveData[COMMAND_DATA_POSITION]));
...
TeIndustrialTestCmdError WriteIoReq_ValidateAndFillAck(TsIndustrialTestCommandListenerInfo* _poListenerArg, ToTestFrameId _oTransmitFrameArg, ToTestFrameId _oReceiveFrameArg)
{  
  ...
  if(ET_WRITE_IO_REQ == loc_u8FrameCmdId)
  {
