...
//---------------------------------------------------------------------
// File "BuzzerOff.c"   Generated with SOMFY code generator v[4.6.11.0]
//---------------------------------------------------------------------
...
/*!************************************************************************************************
* \fn         TeIndustrialTestCmdError BuzzerOff_Execute(TsIndustrialTestCommandListenerInfo* _poListenerArg, ToTestFrameId _oTransmitFrameArg, ToTestFrameId _oReceiveFrameArg, TU8 _u8DataSizeArg, TU8* _pu8DataArg)
...
***************************************************************************************************/
TeIndustrialTestCmdError BuzzerOff_Execute(TsIndustrialTestCommandListenerInfo* _poListenerArg, ToTestFrameId _oTransmitFrameArg, ToTestFrameId _oReceiveFrameArg, TU8 _u8DataSizeArg, TU8* _pu8DataArg)
{  
  /*## BEGIN[GUID 8c1f242d-04a5-4256-b071-29ba6bd66995] ##*/
  TU8                                   loc_pu8DataLength = 0U;
  TU8                                   loc_u8Data[ET_BUZZER_OFF_LENGTH];
  ...
  //Initialize chart
  MEMSET(loc_u8Data, 0, ET_BUZZER_OFF_LENGTH);
  ...
  loc_eReturnValue = IndustrialTestCommandListener_Notify(_poListenerArg, ET_BUZZER_OFF, loc_u8Data);
  ...
  return loc_eRetVal;
  /*## END[GUID 8c1f242d-04a5-4256-b071-29ba6bd66995] ##*/
}


/*!************************************************************************************************
* \fn         TeIndustrialTestCmdError BuzzerOff_ValidateAndFillAck(TsIndustrialTestCommandListenerInfo* _poListenerArg, ToTestFrameId _oTransmitFrameArg, ToTestFrameId _oReceiveFrameArg)
* \param[in]  _poListenerArg
* \param[in]  _oTransmitFrameArg
* \param[in]  _oReceiveFrameArg
* \return     TeIndustrialTestCmdError 
***************************************************************************************************/
TeIndustrialTestCmdError BuzzerOff_ValidateAndFillAck(TsIndustrialTestCommandListenerInfo* _poListenerArg, ToTestFrameId _oTransmitFrameArg, ToTestFrameId _oReceiveFrameArg)
{  
  /*## BEGIN[GUID 38170fc9-4471-4728-b79b-995ef09dbb38] ##*/
  ...
  if(ET_BUZZER_OFF == loc_u8FrameCmdId)
  {
  ...
  /*## END[GUID 38170fc9-4471-4728-b79b-995ef09dbb38] ##*/
}
