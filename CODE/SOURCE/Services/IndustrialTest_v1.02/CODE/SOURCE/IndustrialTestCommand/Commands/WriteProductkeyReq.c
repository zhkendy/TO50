...
//---------------------------------------------------------------------
// File "WriteProductkeyReq.c"   Generated with SOMFY code generator v[4.6.11.0]
//---------------------------------------------------------------------
...
/*!************************************************************************************************
* \fn         TeIndustrialTestCmdError WriteProductkeyReq_Execute(TsIndustrialTestCommandListenerInfo* _poListenerArg, ToTestFrameId _oTransmitFrameArg, ToTestFrameId _oReceiveFrameArg, TU8 _u8DataSizeArg, TU8* _pu8DataArg)
...
{  
  /*## BEGIN[GUID 4acf1e4b-30a1-4864-b890-3ed0a9f4bbbd] ##*/
  ...
  loc_eReturnValue = IndustrialTestCommandListener_Notify(_poListenerArg, ET_WRITE_PRODUCTKEY_REQ, loc_u8ReceiveData);
  ...
  /*## END[GUID 4acf1e4b-30a1-4864-b890-3ed0a9f4bbbd] ##*/
}


/*!************************************************************************************************
* \fn         TeIndustrialTestCmdError WriteProductkeyReq_ValidateAndFillAck(TsIndustrialTestCommandListenerInfo* _poListenerArg, ToTestFrameId _oTransmitFrameArg, ToTestFrameId _oReceiveFrameArg)
* \param[in]  _poListenerArg
* \param[in]  _oTransmitFrameArg
* \param[in]  _oReceiveFrameArg
* \return     TeIndustrialTestCmdError 
...
{  
  /*## BEGIN[GUID 6f5ecf7b-b0fe-47e8-9234-b7d7240924f9] ##*/
  ...
  if(ET_WRITE_PRODUCTKEY_REQ == loc_u8FrameCmdId)
  {
  ...
  /*## END[GUID 6f5ecf7b-b0fe-47e8-9234-b7d7240924f9] ##*/
}
