...
//---------------------------------------------------------------------
// File "GetVoltReq.c"   Generated with SOMFY code generator v[4.6.11.0]
//---------------------------------------------------------------------
...
/*!************************************************************************************************
* \fn         TeIndustrialTestCmdError GetVoltReq_Execute(TsIndustrialTestCommandListenerInfo* _poListenerArg, ToTestFrameId _oTransmitFrameArg, ToTestFrameId _oReceiveFrameArg, TU8 _u8DataSizeArg, TU8* _pu8DataArg)
...
{  
  /*## BEGIN[GUID ab5cc06a-3c71-4a76-b4cd-0586e09905e6] ##*/
  TU8                                   loc_u8DataSize              = 0U;
  TU8                                   loc_u8Data[MAX_GET_VOLT_SIZE];
  ...
  TU8                                   loc_u8ReceiveData[MAX_GET_VOLT_SIZE];
  TU8                                   loc_u8AckValue              = ACK_KO;
  TU8                                   loc_u8FrameHeader = 0U;
  
  //Initialize charts
  MEMSET(loc_u8Data, 0, MAX_GET_VOLT_SIZE);
  MEMSET(loc_u8ReceiveData,0,MAX_GET_VOLT_SIZE);
  ...
  loc_eReturnValue = IndustrialTestCommandListener_GetInfo(_poListenerArg, ET_GET_VOLT_REQ, &(loc_u8ReceiveData[COMMAND_DATA_POSITION]), &loc_u8DataSize, loc_u8Data);
  ...
  else
  {
    ...
    //Build answer frame
    loc_eTestFrameRetVal = TestFrame_UpdateTestFrame(_oTransmitFrameArg, ET_GET_VOLT_ANS, loc_u8DataSize, loc_u8Data, FALSE, FALSE);
  ...
  return loc_eRetVal;
  /*## END[GUID ab5cc06a-3c71-4a76-b4cd-0586e09905e6] ##*/
}


/*!************************************************************************************************
* \fn         TeIndustrialTestCmdError GetVoltReq_ValidateAndFillAck(TsIndustrialTestCommandListenerInfo* _poListenerArg, ToTestFrameId _oTransmitFrameArg, ToTestFrameId _oReceiveFrameArg)
* \param[in]  _poListenerArg
* \param[in]  _oTransmitFrameArg
* \param[in]  _oReceiveFrameArg
* \return     TeIndustrialTestCmdError 
...
{  
  /*## BEGIN[GUID f8f88773-bd09-4b4f-b8fe-96c6f4396f7d] ##*/
  ...
  if(ET_GET_VOLT_REQ == loc_u8FrameCmdId)
  {
  ...
  /*## END[GUID f8f88773-bd09-4b4f-b8fe-96c6f4396f7d] ##*/
}
