...
//---------------------------------------------------------------------
// File "RtcMeasuredFreq.c"   Generated with SOMFY code generator v[4.6.11.0]
//---------------------------------------------------------------------
...
/*!************************************************************************************************
* \fn         TeIndustrialTestCmdError RtcMeasuredFreq_Execute(TsIndustrialTestCommandListenerInfo* _poListenerArg, ToTestFrameId _oTransmitFrameArg, ToTestFrameId _oReceiveFrameArg, TU8 _u8DataSizeArg, TU8* _pu8DataArg)
...
{  
  /*## BEGIN[GUID 4dfbe32c-f20f-405c-b41f-b249030c8158] ##*/
  ...
  loc_eTestCmdListenerRetVal = IndustrialTestCommandListener_Notify(_poListenerArg, ET_RTC_MEASURED_FREQ, loc_u8ReceiveData);
  ...
  /*## END[GUID 4dfbe32c-f20f-405c-b41f-b249030c8158] ##*/
}


/*!************************************************************************************************
* \fn         TeIndustrialTestCmdError RtcMeasuredFreq_ValidateAndFillAck(TsIndustrialTestCommandListenerInfo* _poListenerArg, ToTestFrameId _oTransmitFrameArg, ToTestFrameId _oReceiveFrameArg)
* \param[in]  _poListenerArg
* \param[in]  _oTransmitFrameArg
* \param[in]  _oReceiveFrameArg
* \return     TeIndustrialTestCmdError 
...
{  
  /*## BEGIN[GUID a86f246b-b83c-4fe2-baf9-0597e8de8a18] ##*/
  ...
  if(ET_RTC_MEASURED_FREQ == loc_u8FrameCmdId)
  {
  ...
  /*## END[GUID a86f246b-b83c-4fe2-baf9-0597e8de8a18] ##*/
}
