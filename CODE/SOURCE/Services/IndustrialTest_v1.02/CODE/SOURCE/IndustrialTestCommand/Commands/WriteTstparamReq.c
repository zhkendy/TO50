...
//---------------------------------------------------------------------
// File "WriteTstparamReq.c"   Generated with SOMFY code generator v[4.6.11.0]
//---------------------------------------------------------------------
...
/*!************************************************************************************************
* \fn         TeIndustrialTestCmdError WriteTstparamReq_Execute(TsIndustrialTestCommandListenerInfo* _poListenerArg, ToTestFrameId _oTransmitFrameArg, ToTestFrameId _oReceiveFrameArg, TU8 _u8DataSizeArg, TU8* _pu8DataArg)
...
{  
  ...
  loc_eReturnValue = IndustrialTestCommandListener_Notify(_poListenerArg, ET_WRITE_TSTPARAM_REQ, loc_u8ReceiveData);
  ...
  else
  {
    ...
    loc_u8DataSize = WRITE_TSTPARAM_ANS_DATA_SIZE;
    *loc_u8Data = loc_u8ReceiveData[NB_BYTE_POSITION];
    //Build answer frame
    loc_eTestFrameRetVal = TestFrame_UpdateTestFrame(_oTransmitFrameArg, ET_WRITE_TSTPARAM_ANS, loc_u8DataSize, loc_u8Data, FALSE, FALSE);
...
/*!************************************************************************************************
* \fn         TeIndustrialTestCmdError WriteTstparamReq_ValidateAndFillAck(TsIndustrialTestCommandListenerInfo* _poListenerArg, ToTestFrameId _oTransmitFrameArg, ToTestFrameId _oReceiveFrameArg)
* \param[in]  _poListenerArg
* \param[in]  _oTransmitFrameArg
* \param[in]  _oReceiveFrameArg
* \return     TeIndustrialTestCmdError 
...
{  
  ...
  if(ET_WRITE_TSTPARAM_REQ == loc_u8FrameCmdId)
  {
