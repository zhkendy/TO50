...
//---------------------------------------------------------------------
// File "Read2DCodeReq.c"   Generated with SOMFY code generator v[4.6.11.0]
//---------------------------------------------------------------------
...
/*!************************************************************************************************
* \fn         TeIndustrialTestCmdError Read2DCodeReq_Execute(TsIndustrialTestCommandListenerInfo* _poListenerArg, ToTestFrameId _oTransmitFrameArg, ToTestFrameId _oReceiveFrameArg, TU8 _u8DataSizeArg, TU8* _pu8DataArg)
...
{  
  /*## BEGIN[GUID 3ffb9b05-e5be-4730-a595-daa6ccd5ba75] ##*/
  ...
  MEMSET(loc_u8Data, 0xFF, MAX_DATA_FRAME_SIZE);
  
  TestFrame_GetFrameHeader(_oReceiveFrameArg, &loc_u8FrameHeader);
  
  loc_eReturnValue = IndustrialTestCommandListener_GetInfo(_poListenerArg, ET_READ_2D_CODE_REQ, NULL, &loc_u8DataSize, loc_u8Data);
  ...
  else
  {
    ...
    //Build answer frame
    loc_eTestFrameRetVal = TestFrame_UpdateTestFrame(_oTransmitFrameArg, ET_READ_2D_CODE_ANS, loc_u8DataSize, loc_u8Data, FALSE, FALSE);
  ...
  /*## END[GUID 3ffb9b05-e5be-4730-a595-daa6ccd5ba75] ##*/
}


/*!************************************************************************************************
* \fn         TeIndustrialTestCmdError Read2DCodeReq_ValidateAndFillAck(TsIndustrialTestCommandListenerInfo* _poListenerArg, ToTestFrameId _oTransmitFrameArg, ToTestFrameId _oReceiveFrameArg)
* \param[in]  _poListenerArg
* \param[in]  _oTransmitFrameArg
* \param[in]  _oReceiveFrameArg
* \return     TeIndustrialTestCmdError 
...
{  
  /*## BEGIN[GUID 35d4e54c-50c0-4bc4-bd8f-6c5e5ebbb8b5] ##*/
  ...
  if(ET_READ_2D_CODE_REQ == loc_u8FrameCmdId)
  {
  ...
  /*## END[GUID 35d4e54c-50c0-4bc4-bd8f-6c5e5ebbb8b5] ##*/
}
