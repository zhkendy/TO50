...
//---------------------------------------------------------------------
// File "SignReq.c"   Generated with SOMFY code generator v[4.6.11.0]
//---------------------------------------------------------------------
...
/*!************************************************************************************************
* \fn         TeIndustrialTestCmdError SignReq_Execute(TsIndustrialTestCommandListenerInfo* _poListenerArg, ToTestFrameId _oTransmitFrameArg, ToTestFrameId _oReceiveFrameArg, TU8 _u8DataSizeArg, TU8* _pu8DataArg)
...
***************************************************************************************************/
TeIndustrialTestCmdError SignReq_Execute(TsIndustrialTestCommandListenerInfo* _poListenerArg, ToTestFrameId _oTransmitFrameArg, ToTestFrameId _oReceiveFrameArg, TU8 _u8DataSizeArg, TU8* _pu8DataArg)
{  
  /*## BEGIN[GUID 7988f80b-9af0-4fcf-8722-9a509620dcb4] ##*/
  TU8                                   loc_u8DataSize              = 0U;
  TU8                                   loc_u8Data[MAX_SIGN_SIZE];
  ...
  TU8                                   loc_u8ReceiveData[MAX_SIGN_SIZE];
  TU8                                   loc_u8AckValue              = ACK_KO;
  TU8                                   loc_u8FrameHeader = 0U;
  
  MEMSET(loc_u8ReceiveData,0,MAX_SIGN_SIZE);
  MEMSET(loc_u8Data,0,MAX_SIGN_SIZE);
  ...
  loc_eReturnValue = IndustrialTestCommandListener_GetInfo(_poListenerArg, ET_SIGN_REQ, &(loc_u8ReceiveData[COMMAND_DATA_POSITION]), &loc_u8DataSize, loc_u8Data);
  ...
  else
  {
    ...
    //Build answer frame
    loc_eTestFrameRetVal = TestFrame_UpdateTestFrame(_oTransmitFrameArg, ET_SIGN_ANS, loc_u8DataSize, loc_u8Data, FALSE, FALSE);
  ...
  return loc_eRetVal;
  /*## END[GUID 7988f80b-9af0-4fcf-8722-9a509620dcb4] ##*/
}


/*!************************************************************************************************
* \fn         TeIndustrialTestCmdError SignReq_ValidateAndFillAck(TsIndustrialTestCommandListenerInfo* _poListenerArg, ToTestFrameId _oTransmitFrameArg, ToTestFrameId _oReceiveFrameArg)
* \param[in]  _poListenerArg
* \param[in]  _oTransmitFrameArg
* \param[in]  _oReceiveFrameArg
* \return     TeIndustrialTestCmdError 
***************************************************************************************************/
TeIndustrialTestCmdError SignReq_ValidateAndFillAck(TsIndustrialTestCommandListenerInfo* _poListenerArg, ToTestFrameId _oTransmitFrameArg, ToTestFrameId _oReceiveFrameArg)
{  
  /*## BEGIN[GUID 68694f38-513e-4d35-8d77-1daa71d81282] ##*/
  ...
  if(ET_SIGN_REQ == loc_u8FrameCmdId)
  {
  ...
  /*## END[GUID 68694f38-513e-4d35-8d77-1daa71d81282] ##*/
}
