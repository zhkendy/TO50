...
//---------------------------------------------------------------------
// File "WriteVersionReq.c"   Generated with SOMFY code generator v[4.6.11.0]
//---------------------------------------------------------------------
...
/*!************************************************************************************************
* \fn         TeIndustrialTestCmdError WriteVersionReq_Execute(TsIndustrialTestCommandListenerInfo* _poListenerArg, ToTestFrameId _oTransmitFrameArg, ToTestFrameId _oReceiveFrameArg, TU8 _u8DataSizeArg, TU8* _pu8DataArg)
...
{  
  /*## BEGIN[GUID 4522cf72-d4d3-4016-b17a-9629041c75e5] ##*/
  ...
  loc_eReturnValue = IndustrialTestCommandListener_Notify(_poListenerArg, ET_WRITE_VERSION_REQ, loc_u8ReceiveData);
  ...
  else
  {
    ...
    loc_u8NbBytesWrite = (loc_u8ReceiveData[ET_WRITE_VERSION_ADDRESS_AND_SIZE] & SIZE_MASK);
  
    //build ack answer
    TestFrame_UpdateTestFrame(_oTransmitFrameArg, ET_WRITE_VERSION_ANS, sizeof(loc_u8NbBytesWrite), &loc_u8NbBytesWrite, FALSE, FALSE);
  ...
  /*## END[GUID 4522cf72-d4d3-4016-b17a-9629041c75e5] ##*/
}


/*!************************************************************************************************
* \fn         TeIndustrialTestCmdError WriteVersionReq_ValidateAndFillAck(TsIndustrialTestCommandListenerInfo* _poListenerArg, ToTestFrameId _oTransmitFrameArg, ToTestFrameId _oReceiveFrameArg)
* \param[in]  _poListenerArg
* \param[in]  _oTransmitFrameArg
* \param[in]  _oReceiveFrameArg
* \return     TeIndustrialTestCmdError 
...
{  
  /*## BEGIN[GUID c44b9523-b8d4-4d13-9ddf-64b1e2cc11ae] ##*/
  ...
  if(ET_WRITE_VERSION_REQ == loc_u8FrameCmdId)
  {
  ...
  /*## END[GUID c44b9523-b8d4-4d13-9ddf-64b1e2cc11ae] ##*/
}
